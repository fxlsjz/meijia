/*var baseurl = 'http://pvoice.chinamobo.com/ispa_php/';
var apiurl = baseurl+'api/index.php';*/

var baseurl = 'http://duoke.mobi/';
var apiurl = baseurl+'api/index.php';
var url2 = 'http://duoke.mobi/website/index.php';
var URL=window.location.href;
if(URL.indexOf('pvoice.chinamobo.com')>0)
{
    var baseurl ='http://pvoice.chinamobo.com/o2o_product/';
    var apiurl = baseurl+'api/index.php';
    var url2 = 'http://pvoice.chinamobo.com/o2o_product/website/index.php';
}
function Dbug(a){
...
function alert_info(t, time, time2) {
    var c = $("#alert_info");
    if (c.length == 0) {
        var b = $('<div id="alert_info"><div class="alert_ub ub-pc ub"><div class=bg>' + t + '</div></div></div>');
        $('body').append(b);
    } else {
...
function getDateDiff(dateTimeStamp) {
    ...
    if(t <= 60){
    		...
    		text = datetime.format('M-d h:m'); //一个月内
   }else if(t < 60 * 60 * 24 * 365&&y==0){
    		text = datetime.format('M-d'); //一年内
   }else{
    		text = datetime.format('y-M-d'); //一年以前
    }
	return text;
}
//格式化时间
